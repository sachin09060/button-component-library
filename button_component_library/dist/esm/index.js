...
var Button = function (props) {
    return (jsxRuntimeExports.jsx("div", { children: jsxRuntimeExports.jsx("button", __assign({ className: 'bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded' }, { children: props.label })) }));
};
